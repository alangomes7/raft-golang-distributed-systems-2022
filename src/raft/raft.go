...
// Functions to time management
// Min and max timeout as specification as says
...
// Time management
// Is the time to wait a answer from Leader.
// In case of timeout the raft starts again an looks for a new Leader
...
// Time management of the followers
...
// When the Leader doesn't answer until the timeout the election process start.
// Here we are management the candidates
...
// Append entries after check if they are valid or not
